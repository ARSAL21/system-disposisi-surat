    ...
    public static function all(): array
    {
        ...
        $list = [
            ...
            new AuditContract(
                ...
                domain: AuditDomain::Disposition,
                allowedSubjectTypes: ['disposition_recipient'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Update,
                positionAssignmentRequirement: PositionAssignmentRequirement::Required,
            ),
            new AuditContract(
                ...
                domain: AuditDomain::Disposition,
                allowedSubjectTypes: ['disposition_follow_up'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
                positionAssignmentRequirement: PositionAssignmentRequirement::Required,
            ),
            ...
            new AuditContract(
                ...
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['incoming_letter'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
                positionAssignmentRequirement: PositionAssignmentRequirement::Required,
            ...
            new AuditContract(
                action: AuditAction::OutgoingTemplateVersionCreated,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['outgoing_letter_template'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
                positionAssignmentRequirement: PositionAssignmentRequirement::Required,
            ),
            new AuditContract(
                action: AuditAction::OutgoingTemplateStatusChanged,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['outgoing_letter_template'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Update,
            ...
            new AuditContract(
                action: AuditAction::StandaloneOutgoingDraftCreated,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
                positionAssignmentRequirement: PositionAssignmentRequirement::Required,
            ),
            new AuditContract(
                action: AuditAction::StandaloneOutgoingDocumentVersionCreated,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
            ...
            new AuditContract(
                action: AuditAction::StandaloneOutgoingDraftUpdated,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Update,
            ...
            new AuditContract(
                action: AuditAction::StandaloneOutgoingSubmitted,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Update,
            ...
            new AuditContract(
                action: AuditAction::StandaloneOutgoingReviewed,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Update,
            ...
            new AuditContract(
                action: AuditAction::StandaloneOutgoingEmailLinkIssued,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
            ...
            new AuditContract(
                action: AuditAction::StandaloneOutgoingEmailLinkRevoked,
                domain: AuditDomain::Correspondence,
                allowedSubjectTypes: ['standalone_outgoing_draft'],
                requiresSubjectId: true,
                mutationType: AuditMutationType::Create,
