...
final class StoreTechnicalResponseMaterialController extends Controller
{
    public function __invoke(
        ...
        $action->technicalMaterial($actor, $dossier, $dispositionRecipient, $request->document(), $request->revisionNote());

        return to_route('back-office.letter-responses.show', $dossier)->with('success', 'Bahan teknis berhasil disimpan.');
    }
}
