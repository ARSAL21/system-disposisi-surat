...
class StoreSekdaDispositionRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        Gate::authorize('forwardToAssistants', $recipient);
    ...
    public function rules(): array
    {
        return [
            ...
            'recipient_position_ids.*' => ['required', 'integer', 'distinct', Rule::exists('positions', 'id')],
    ...
    {
        return array_values(array_map(static fn (mixed $id): int => (int) $id, (array) $this->validated('recipient_position_ids')));
    }
