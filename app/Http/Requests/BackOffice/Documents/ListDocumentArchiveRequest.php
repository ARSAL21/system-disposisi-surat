...
class ListDocumentArchiveRequest extends FormRequest
{
    public function authorize(): bool
    {
        Gate::authorize('viewAny', IncomingLetter::class);
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', 'nullable', 'string', Rule::enum(IncomingLetterStatus::class)],
