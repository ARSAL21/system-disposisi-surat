 ...
 * @property SubmissionDecisionOutcome $outcome
...
class SubmissionDecision extends Model
{
    ...
    {
        return [
            'outcome' => SubmissionDecisionOutcome::class,
            'created_at' => 'datetime',
        ];
    }
    ...
    {
        static::updating(fn () => throw new LogicException('Submission decisions are append-only.'));
        static::deleting(fn () => throw new LogicException('Submission decisions are append-only.'));
    }
