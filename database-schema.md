...
erDiagram
    ...
    POSITIONS ||--o{ POSITION_RELATIONSHIPS : relates
    LETTER_ROUTES ||--o{ EXPERT_CONSULTATIONS : consults
    EXPERT_CONSULTATIONS ||--o| EXPERT_CONSULTATION_REPORTS : reports
    EXPERT_CONSULTATIONS ||--o{ EXPERT_CONSULTATION_DOCUMENTS : stores
```
