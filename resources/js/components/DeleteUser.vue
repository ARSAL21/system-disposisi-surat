        ...
        >
            ...
            >
                <div class="space-y-1">
                    ...
                    <p
                        class="max-w-lg text-xs leading-relaxed text-rose-700/90 dark:text-rose-300/80"
                    >
                        Setelah akun Anda dihapus, semua data dan riwayat
                        terkait akan dihapus secara permanen. Harap berhati-hati
                        sebelum melanjutkan.
                    </p>
                </div>
                ...
                <Dialog>
                    <DialogTrigger as-child>
                        <Button
                            ...
                            class="shrink-0 gap-2 bg-rose-600 font-medium text-white shadow-xs hover:bg-rose-700 dark:bg-rose-600 dark:hover:bg-rose-500"
                        >
                            <Trash2 class="size-4" />
                            Hapus Akun
                        </Button>
                    ...
                    <DialogContent class="sm:max-w-md">
                        ...
                        >
                            <DialogHeader class="space-y-2 text-left">
                                <div
                                    class="flex size-11 items-center justify-center rounded-2xl bg-rose-100 text-rose-600 dark:bg-rose-950 dark:text-rose-300"
                                >
                                ...
                                >
                                    ...
                                    Masukkan kata sandi akun Anda untuk
