    ...
    <div class="grid gap-3 p-3 lg:hidden">
        ...
        >
            ...
            <div class="mt-4 flex gap-3">
                <span class="flex size-9 shrink-0 items-center justify-center rounded-xl bg-blue-500/10 text-blue-700 dark:text-blue-300">
            ...
            <dl class="mt-5 grid gap-4 text-sm sm:grid-cols-2">
                <div class="flex gap-3">
                    <Building2 class="mt-0.5 size-4 shrink-0 text-violet-600 dark:text-violet-300" aria-hidden="true" />
                    <div>
                        <dt class="text-xs text-muted-foreground">Asal surat</dt>
                ...
                <div class="flex gap-3">
                    <Clock3 class="mt-0.5 size-4 shrink-0 text-blue-600 dark:text-blue-300" aria-hidden="true" />
                    <div>
            ...
            <div class="mt-4 flex items-start gap-3 rounded-xl bg-muted/55 p-3">
                <Send class="mt-0.5 size-4 shrink-0 text-emerald-700 dark:text-emerald-300" aria-hidden="true" />
                <div>
            ...
            <ul class="mt-4 flex flex-wrap gap-2" aria-label="Instruksi disposisi">
                <li
