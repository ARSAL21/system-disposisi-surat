    ...
    <div class="hidden overflow-x-auto lg:block">
        <table class="w-full min-w-6xl text-left text-sm">
            ...
            <thead class="border-b bg-slate-50/75 dark:bg-slate-900/50">
                <tr class="text-xs font-semibold tracking-wide text-muted-foreground uppercase">
                ...
                >
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 font-mono text-xs text-muted-foreground">
                                    Agenda {{ disposition.letter.agenda_number }}
                                </p>
                    ...
                    <td class="min-w-56 px-5 py-4 align-top">
                        <div class="flex gap-2.5">
                            <Send class="mt-0.5 size-4 shrink-0 text-violet-700 dark:text-violet-300" aria-hidden="true" />
                            <div>
                                <p class="font-semibold">{{ disposition.sender.name }}</p>
                    ...
                    <td class="max-w-xs px-5 py-4 align-top">
                        ...
                        <Badge
                            ...
                            :class="[
                                'mt-2',
                                dispositionRecipientStatusClass(disposition.status),
                            ]"
                        >
