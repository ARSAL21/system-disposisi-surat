...
<template>
    <section
        class="rounded-3xl border border-emerald-500/30 bg-card p-6 shadow-sm dark:border-emerald-500/20 dark:bg-slate-900/80"
    >
        <!-- Header -->
        <div
        ...
        >
            <div class="flex items-center gap-3">
                <div
                    class="flex size-10 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-600 dark:bg-emerald-400/10 dark:text-emerald-400"
                >
        ...
        <div class="mt-5 space-y-4">
            ...
            <div class="space-y-2">
                ...
                <div class="grid gap-2">
                    ...
                    >
                        ...
                        <Badge
                            variant="outline"
                            class="shrink-0 px-2 py-0.5 font-mono text-[10px] font-bold"
                            :class="
                                dispositionRecipientStatusClass(
                                    recipient.status,
                                )
            ...
            <div
                class="flex items-center justify-between gap-3 rounded-2xl bg-muted/40 p-3.5 text-xs"
            >
                <div class="min-w-0">
                    ...
                    <p class="text-[11px] text-muted-foreground">
                        ...
                        <template v-if="disposition.disposed_by.unit"
                            >· {{ disposition.disposed_by.unit }}</template
                        >
                    </p>
                </div>
                <span
            ...
            >
                ...
                />
                <span
                    >Disposisi tersimpan secara append-only dalam audit
                    log.</span
                >
            </div>
        </div>
