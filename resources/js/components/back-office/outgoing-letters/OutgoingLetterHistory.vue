    ...
    <Card>
        <CardHeader class="pb-3"
            ><CardTitle class="flex items-center gap-2 text-base"
                ><History class="size-4 text-indigo-600" /> Jejak
                penerbitan</CardTitle
            ></CardHeader
        >
        <CardContent>
            <ol class="space-y-0">
                ...
                >
                    <span
                        ...
                        class="absolute top-8 bottom-0 left-4 w-px bg-border"
                        aria-hidden="true"
                    />
                    <span
                        ...
                        :class="
                            entry.state === 'DONE'
                                ...
                                : entry.state === 'STOPPED'
                                  ...
                                  : 'border-indigo-500 bg-background text-indigo-600 ring-4 ring-indigo-500/10'
                        "
                        ><Check
                            v-if="entry.state === 'DONE'"
                            class="size-3.5" /><Clock3 v-else class="size-3.5"
                    /></span>
                    <div class="min-w-0 pt-1">
                        ...
                        <p class="mt-2 text-xs font-medium">
                            {{ entry.actor_name }} · {{ entry.actor_position }}
                        </p>
                    </div>
                </li>
            </ol>
