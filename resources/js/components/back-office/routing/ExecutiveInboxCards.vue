...
<template>
    <div class="grid grid-cols-1 gap-5">
        ...
        >
                    ...
                    >
                        <span
                            v-if="
                                ...
                                'AWAITING_DECISION'
                            "
                            class="mr-1.5 size-1.5 animate-pulse rounded-full bg-amber-500"
                        />
                        <span>{{
            ...
            <div
                class="mt-4 flex flex-col justify-between gap-6 lg:flex-row lg:items-start"
            >
                <div class="space-y-3 lg:max-w-2xl">
                    <div class="flex items-start gap-3">
                        <div
                            class="mt-0.5 flex size-10 shrink-0 items-center justify-center rounded-2xl bg-indigo-600/10 text-indigo-600 dark:bg-indigo-400/10 dark:text-indigo-400"
                        >
                            <FileText class="size-5" />
                        </div>
                        <div>
                            <h2
                                class="font-['Syne',sans-serif] text-base leading-snug font-bold text-foreground sm:text-lg"
                            >
                ...
                <div class="flex shrink-0 items-center lg:self-center">
                    ...
                    >
                        ...
                        <ArrowRight
                            class="size-4 transition-transform group-hover/btn:translate-x-1"
                        />
                    </Link>
                </div>
            </div>
            ...
            <div
                class="mt-5 grid grid-cols-1 gap-3 border-t border-border/60 pt-4 sm:grid-cols-2 lg:grid-cols-3 dark:border-border/40"
            >
                ...
                >
                    ...
                    <div class="min-w-0">
                        <p
                            class="font-mono text-[10px] text-muted-foreground uppercase"
                        >
                            Dokumen Resmi (SHA-256):
                        </p>
                        <p class="truncate font-semibold text-foreground">
                            {{
                                route.letter.current_document
                                    ?.original_filename ?? 'Naskah Digital'
                            }}
                        </p>
                        <p class="font-mono text-[10px] text-muted-foreground">
                            {{
                                formatRoutingFileSize(
                                    route.letter.current_document?.size_bytes ??
                                        0,
                                )
                            }}
                            · Terverifikasi
                ...
                <div
                    class="flex items-center gap-2.5 rounded-2xl border border-border/60 bg-muted/40 p-3 text-xs sm:col-span-2 lg:col-span-1"
                >
                    <GitBranch
                    ...
                    <div class="w-full min-w-0">
                        ...
                        >
                            <span
                                class="font-mono text-[10px] text-muted-foreground uppercase"
                                >Progres Tindak Lanjut</span
                            >
                            <span class="font-bold text-foreground">
                                {{ route.branch_progress.completed }}/{{
                                    route.branch_progress.total
                                }}
                                Selesai
                            </span>
                        </div>
                        ...
                        >
                            <div
                                ...
                                :style="{
                                    width: `${route.branch_progress.percent_complete}%`,
                                }"
                            />
                        </div>
                    </div>
