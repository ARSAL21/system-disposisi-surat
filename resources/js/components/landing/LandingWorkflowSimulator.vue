...
<template>
    ...
    >
        <div
            class="rounded-3xl border border-slate-200/80 bg-gradient-to-b from-white/95 to-slate-50/90 p-6 shadow-2xl shadow-slate-900/5 backdrop-blur-2xl sm:p-10 dark:border-slate-800 dark:from-slate-900/90 dark:to-slate-950/95"
        >
            <!-- Sandbox Title & Control Bar -->
            <div
                class="flex flex-col gap-4 border-b border-slate-200/70 pb-6 sm:flex-row sm:items-center sm:justify-between dark:border-slate-800"
            >
                <div>
                    <div
                    ...
                    <h2
                        class="mt-1 font-['Syne',sans-serif] text-2xl font-extrabold text-slate-900 sm:text-3xl dark:text-white"
                    >
                ...
                >
                    ...
                    <span>{{
                        isSimAutoPlaying
                            ? 'Hentikan Putar Otomatis'
                            : 'Putar Simulasi Otomatis'
                    }}</span>
                </button>
            </div>
            ...
            <div class="mt-6 grid grid-cols-2 gap-2 sm:grid-cols-4">
                ...
                >
                    ...
                    <span class="w-full truncate text-xs font-bold">
                        {{ stage.code }}
                    </span>
                </button>
            </div>
            ...
            <div
                class="mt-8 rounded-2xl border border-slate-200/70 bg-white/70 p-6 sm:p-8 dark:border-slate-800 dark:bg-slate-950/60"
            >
                <div
                    v-for="stage in workflowStages"
                ...
                >
                    ...
                    >
                        <div class="space-y-1">
                            ...
                            <h3
                                class="font-['Syne',sans-serif] text-xl font-bold text-slate-900 sm:text-2xl dark:text-white"
                            >
                                {{ stage.title }}
                            </h3>
                            <p
                    ...
                    <!-- Invariants List -->
                    <div
                        class="rounded-xl border border-slate-200/60 bg-slate-50/70 p-4 dark:border-slate-800 dark:bg-slate-900/60"
                    >
                        <span
