...
<template>
    ...
    <div class="h-screen bg-slate-50 text-slate-900 selection:bg-indigo-500 selection:text-white dark:bg-slate-950 dark:text-slate-100 flex items-center justify-center overflow-hidden relative select-none [font-family:'Plus_Jakarta_Sans',system-ui,sans-serif]">
        <!-- Ambient Subtle Mesh (Static, Clean) -->
        <div class="fixed inset-0 pointer-events-none overflow-hidden z-0">
            <div class="absolute inset-0 [background-image:radial-gradient(rgba(99,102,241,0.06)_1px,transparent_1px)] [background-size:32px_32px] opacity-70 dark:[background-image:radial-gradient(rgba(129,140,248,0.05)_1px,transparent_1px)]" />
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-gradient-to-tr from-indigo-500/10 via-purple-500/10 to-pink-500/10 dark:from-indigo-500/15 dark:via-purple-500/15 dark:to-pink-500/15 rounded-full blur-[110px] pointer-events-none" />
        </div>
        ...
        <main class="relative z-10 w-full max-w-3xl px-4 py-8 text-center flex flex-col items-center justify-center">
            ...
            <div class="relative select-none pointer-events-none z-0">
                <h1 class="[font-family:'Syne',system-ui,sans-serif] text-7xl sm:text-8xl md:text-9xl lg:text-[10.5rem] font-extrabold tracking-tighter leading-none text-slate-800 dark:text-slate-100 drop-shadow-sm select-none">
                    {{ props.status }}
                </h1>
            </div>
            ...
            <div class="relative z-10 -mt-6 sm:-mt-8 md:-mt-10 lg:-mt-12 flex flex-col items-center px-4">
                ...
                <h2 class="[font-family:'Syne',system-ui,sans-serif] text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold uppercase tracking-tight text-slate-900 dark:text-white max-w-xl leading-tight drop-shadow-xs">
                ...
                <p class="mt-4 text-sm sm:text-base md:text-lg font-medium text-slate-600 dark:text-slate-300 max-w-xl mx-auto leading-relaxed flex flex-wrap items-center justify-center gap-2">
                    ...
                    >
                        ...
                        <ArrowLeft class="size-3.5 transition-transform duration-200 group-hover:-translate-x-0.5" />
                    </button>
                </p>
            </div>
        </main>
