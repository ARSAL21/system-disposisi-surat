        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 580px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -2px rgba(0, 0, 0, 0.05); border: 1px solid #e2e8f0;">
                    ...
                    <!-- Header Banner -->
                    <tr>
                        <td style="background: linear-gradient(135deg, #059669 0%, #0d9488 100%); padding: 32px 36px; text-align: center;">
                            <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <!-- Emblem Icon -->
                                        <div style="display: inline-block; width: 48px; height: 48px; line-height: 48px; background-color: rgba(255, 255, 255, 0.2); border-radius: 12px; margin-bottom: 12px;">
                                        ...
                                        <p style="margin: 6px 0 0 0; font-size: 13px; color: rgba(255, 255, 255, 0.9);">
                                            Layanan Pengajuan & Verifikasi Akun Publik
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 36px 36px 28px 36px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 14px; line-height: 1.6; color: #475569;">
                                Terima kasih telah membuat akun di <strong>{{ config('app.name', 'Sistem Disposisi Surat') }}</strong>. Untuk memastikan keamanan data dan mengaktifkan akun Anda agar dapat mulai mengajukan permohonan surat serta memantau disposisi, silakan klik tombol verifikasi di bawah ini:
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 16px;">
                                        <p style="margin: 0; font-size: 12px; line-height: 1.5; color: #64748b;">
                                            ⏱️ <strong>Batas Waktu:</strong> Tautan verifikasi ini akan aktif selama <strong>60 menit</strong>. Jika Anda tidak pernah merasa mendaftar di layanan ini, abaikan email ini dengan aman.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="margin-top: 24px; padding-top: 20px; border-top: 1px solid #f1f5f9;">
                                <p style="margin: 0 0 8px 0; font-size: 12px; color: #94a3b8;">
                                    Jika tombol di atas mengalami kendala, salin dan buka tautan berikut pada peramban web Anda:
                                </p>
